...
chcp 65001
echo %date% %time%^>fileCreate>D:\Project\MJH_JavaProject_v2\web01\src\cmdLog\%date:-=%^_%time:~0,2%%time:~3,2%%time:~6,2%.txt
pause
...
echo %date% %time%^>파일생성> D:\Project\MJH_JavaProject_v2\web01\src\cmdLog\%date:-=%^_%time%.txt